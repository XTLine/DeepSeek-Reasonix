...
var English = Messages{
	TakeoverView:     "View saved history, read-only (v)",
	TakeoverViewHint: "Read-only snapshot · R: retry resume · V: refresh · Esc: back · Q: exit",
	...
	TakeoverTerminalPrompt: "Choose w / i / v, or Enter to cancel:",
